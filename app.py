...
with t_tech:
    ...
    if use_boil:
        ...
        st.info("ℹ️ Plynový kotel není na lokalitě instalován – výkon a účinnost jsou nastaveny na 0. Odškrtněte zdroj v postranním panelu pro vyřazení z optimalizace.")
        p['b_max']    = st.number_input("Max. výkon [MW]",    value=0.0)
    ...
    if use_ek:
        ...
        p['ek_max'] = st.number_input("Max. výkon [MW]",  value=0.414)
    ...
    if use_tes:
        ...
        p['tes_cap']  = st.number_input("Kapacita [MWh]", value=1.0)
    ...
    if use_ext_heat:
        ...
        p['imp_max'] = st.number_input("Max. výkon [MW]", value=5.0)
